...
public class Thermometer extends View {
    ...
    public Thermometer (Context context, AttributeSet attributeSet, int defStyleAttr){
    ...
    public void init(Context context, AttributeSet attributeSet){
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.Thermometer);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float circleCenterY = height - outerRectRadius;
        float outerStartY = 0;
        ...
        float inc = rangeTemp / nbGraduations;
         ...
         while (tmp <= innerEffectEndY){
             ...
             canvas.drawText(((int)startGraduation)+ "°", circleCenterX - outerRectRadius - DEGREE_WIDTH - textWidth - DEGREE_WIDTH * 1.5f, tmp + textHeight / 2, graduationPaint);
